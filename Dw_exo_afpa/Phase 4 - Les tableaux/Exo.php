...
<html lang="fr">
    ...
    for ($i=0;$i<$y;$i++){
        if($a["19002"][$i]=="Validation"){
            $st=$i;
            $st++;
            echo " la semaine a lieu la validation du groupe 19002 est :  ".$st."<br/>";
        }else{}
    }

    echo "<hr>Exo2 :";
    //Trouver la position de la derniére occurence de Stage pour le groupe 19001 ?
    $x =0;
    $t =count($a["19001"]);
    for ($i =0;$i < $t; $i++){
        if ($a["19001"][$i] == "Stage"){
    ...
    echo " la position de la derniére occurence de Stage pour le groupe 19001 est : ".$x;
    ...
    echo "le stage du groupe 19003 a duré : ".count($tab1)." semaines<hr>";
?>
        </header>
        <footer>
        </footer>
